...
const randomEmailId = chance.email({ domain: 'example.com' });
...
describe("Aura Code Challenge - Create User Account Tests", () => {
  ...
  it("registration form loaded and completing process", () => {
    ...
    .then(() => browser.wait(EC.presenceOf(customerLastNameElement()), timeout))
    ...
    .then(() => stateElement().element(by.cssContainingText('option', 'Arkansas')).click())
